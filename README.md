...
> [!IMPORTANT]
> This is not a simple compute offload: **every responsibility delegated to AWS directly eliminates a real in-flight failure mode** that may endanger the aircraft, corrupt mission data, or leave the pilot blind to a safety breach.
